...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=3 --timeout=0 --decimals=8 --description=BTC/USD-0-timeout --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=ETH/USD-60-timeout --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=3 --timeout=0 --decimals=8 --description=FB/USD-0-timeout --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
    ./gauntlet-terra-linux setupFeed --network=$NETWORK --paymentAmount=1 --minSubmissionValue=0 --maxSubmissionValue=99999999999999999999999999999 --minSubmissionCount=1 --timeout=60 --decimals=8 --description=AMZN/USD-60-timeout  --rdd=./scripts/terrajs/addresses.json terra1757tkx08n0cqrw7p86ny9lnxsqeth0wgp0em95 terra17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp terra199vw7724lzkwz6lf2hsx04lrxfkz09tg8dlp6r
